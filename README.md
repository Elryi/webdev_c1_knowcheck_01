...
- [Y] 1. Add `Viewport` metatag
- [Y] 2. Center div `hero-content` in `hero` section
- [Y] 3. Change `Hero` button `:hover` colors.
- [Y] 4. Change photo in `About Me` section.
- [N] 5. BONUS: Add a `Contact` section.
